    ...
    def estimate_size(
        ...
        for i in range(self.child_count):
            ...
            if child.autofit:
                ...
                layout_constaint = PyDuiLayoutConstraint(child_max_w, layout_max_h - margin_h)
                if fit_w:
                ...
                # estimate child size
                child_w, child_h = child.estimate_size(child_max_w, layout_max_h - margin_h, layout_constaint)
